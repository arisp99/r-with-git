...
- The country of the richest man in history (Mansa Musa)!

```{r, eval =T, echo = F, out.width='50%', fig.align='center', fig.cap='Mansa Musa'}
knitr::include_graphics('images/Mansa_Musa.jpg')
```
...
```{r, eval = T, echo = F, out.width='80%', fig.align='center', fig.cap='Sunset in the Mara'}
knitr::include_graphics('images/sunset.jpg')
```

## Haiti (I know I talk about this all the time!)

- Haiti was the first country in the western Hemisphere to abolish slavery and
the only to have a successful revolt!

```{r, eval = T, echo = F, out.width='45%', fig.show='hold', fig.align='center', fig.cap='Whole Hearted Orphanage and me at a refugee camp at the boarder of Haiti and the DR'}
knitr::include_graphics('images/haiti_1.jpg')
knitr::include_graphics('images/haiti_2.jpg')
```

## Liberia

- Liberia does not use the metric system

```{r, eval = T, echo = F, out.width='80%', fig.align='center', fig.cap='West Point, Monrovia'}
knitr::include_graphics('images/liberia.jpg')
```
