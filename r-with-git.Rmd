...
- Haiti was the first country in the western Hemisphere to abolish slavery and the only to have a successful revolt! 

```{r, eval = T, echo = F, out.width='40%', fig.show='hold', fig.align='center', fig.cap='Whole Hearted Orphanage and me at a refugee camp at the boarder of Haiti and the DR'}
